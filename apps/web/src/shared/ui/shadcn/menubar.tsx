...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        "bg-popover text-popover-foreground ring-foreground/10 data-open:animate-in data-open:fade-in-0 min-w-36 rounded-lg p-1 shadow-md ring-1 duration-75",
        className
      )}
      {...props}
    />
...
function MenubarSubContent({
  ...
  return (
    <DropdownMenuSubContent
      ...
      className={cn(
        "bg-popover text-popover-foreground ring-foreground/10 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 min-w-32 rounded-lg p-1 shadow-lg ring-1 duration-75",
        className
      )}
      {...props}
    />
