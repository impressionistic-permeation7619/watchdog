...
interface InboxQueueToolbarProps {
  filters: InboxQueueFilters;
  onFiltersChange: (next: InboxQueueFilters) => void;
  pendingCount: number;
}

export function InboxQueueToolbar({
  filters,
  onFiltersChange,
  pendingCount,
}: InboxQueueToolbarProps) {
      ...
      center={
        <>
          ...
          <PageFilterMenu
            chips={filterChips}
            onClearAll={() => {
              onFiltersChange({ ...EMPTY_INBOX_FILTERS, q: filters.q });
            }}
