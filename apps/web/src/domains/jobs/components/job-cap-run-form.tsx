            ...
            return (
              <>
                ...
                <form.Field name="runInput">
                  {(runField) => (
                    <Input
                      className="h-8 min-w-[12rem] flex-1 text-xs sm:w-56 sm:flex-none"
                    ...
                    <WithTooltip
                      ...
                      content={
                        entityField.state.value === ""
                          ? "No Entity — captures Evidence only (no Inbox Proposal)."
                          : null
                      }
                    >
                      <EntityCombobox
                  ...
                  content={
                    ...
                    view.blockedReason !== undefined ? (
                      ...
                      (view.showEvidenceOnlyHint
                        ? "Runs without Entity — Evidence only, no Inbox Proposal."
                        : null))
                    )
                  }
                >
