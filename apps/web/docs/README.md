...
| [`UI.md`](UI.md) | Design system, tokens, atoms, chrome lexicon, loading/hydration **implementation** | Product flows, copy |
...
Code SoT for visuals: `src/styles.css` + `src/shared/ui/` (+ `shadcn/` registry). Page chrome: `src/shared/layout/` (`Page`, toolbars, `RoutePending` / `RouteError`). Not Figma.
