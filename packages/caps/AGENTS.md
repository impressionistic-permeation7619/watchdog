...
- **Naming / ship gates:** [`docs/CAPS.md`](../../docs/CAPS.md) — id/title/kind layers, method vocabulary, D1–D5 (incl. breach credential bodies), passive=`useCases` Passive/Footprint vs active=`invasive`+Active, one HTTP-surface Cap, public-vs-paid split.
...
| Need                  | File                                                 |
| --------------------- | ---------------------------------------------------- |
| Cap naming / lexicon  | [`docs/CAPS.md`](../../docs/CAPS.md)                 |
